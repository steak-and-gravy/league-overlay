...
- **Pit Stop Indicator** — Optional race-only Car # outline that stays visible until a valid pit stop is completed after lap 1.
...
- Pit Stop Indicator toggle for the race-only Car # mandatory-stop indicator
...
- **Pit Stop Indicator toggle**: In races, the Car # outline stays visible until a valid pit stop after lap 1 is completed. Disable this in Settings if your league does not require it.
